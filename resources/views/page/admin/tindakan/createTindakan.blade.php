      ...
      <div class="card full-height">
        <div class="card-header">
          <div class="card-head-row">
            ...
            <a href="{{ route('periksa.create') }}" class="btn btn-primary btn-sm ml-auto">Back</a>
          </div>
        </div>

        <div class="card-body">
          <form action="{{ route('tindakan.storeTindakan') }}" method="POST" enctype="multipart/form-data">
            @csrf
