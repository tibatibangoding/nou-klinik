				...
				<div class="card-body">
					<form action="{{ route('obat.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							...
							<a href="{{ route('createKategoriObat') }}" class="btn-sm btn-primary ml-3">+ Tambah Kategori</a>
                        ...
                        <div class="form-group">
							...
							<a href="{{ route('createJenisObat') }}" class="btn-sm btn-primary ml-3">+ Tambah Jenis</a>
