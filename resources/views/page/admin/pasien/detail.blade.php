...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <a href="{{ route('pasien.showAll', $pasien->id) }}" class="btn text-white" style="background-color: #a979a8;"
    onmouseover="this.style.backgroundColor='#6c5576';" onmouseout="this.style.backgroundColor='#a979a8';">Detail
    seluruh pemeriksaan</a>
  @if (Auth::user()->roles->pluck('name')[0] == 'admin')
  <a href="{{ route('periksa.edit', $periksa->id) }}" class="btn btn-outline-custom">Edit Pemeriksaan</a>
  @endif
</div>
  ...
  <div class="row d-flex">
    <div class="col-md-12" style="margin-left:-20px">
      <div class="card mb-4">
        <div class="card-header">
          <h3 class="text-success"><span class="text-dark">Nama Pasien : </span>{{ $pasien->nama_pasien }}, <span
              class="text-dark">Alergi Pasien : </span>{{ $pasien->alergi }}</h3>
          <h5>({{ $pasien->jenis_kelamin }} | {{ Carbon\Carbon::parse($pasien->tgl_lahir)->age }}
            ({{ $pasien->tgl_lahir }}) | Keluhan : {{ $pendaftaran->keluhan }} | Nomor Antrian :
            {{ $pendaftaran->no_antrian }})</h5>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card mb-4 ml-2">
        ...
        <div class="card-body">
          <div class="card mb-3">
            <div class="card-header">{{ $tindakan_single->user->nama }} | Jenis Tindakan :
              {{ $tindakan_single->tindakan->nama_tindakan }}</div>
            <div class="card-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <b class="text-warning">Belum Lunas / DP</b>
                @endif
              </td>
              </td>
            </tr>
