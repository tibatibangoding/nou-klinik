      ...
      <div class="card full-height">
        <div class="card-header">
          <div class="card-head-row">
            <h1 class="card-title">Tambah Pendaftaran</h1>
        ...
        <div class="card-body">
          <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <a href="{{ route('pendaftaran.all') }}" class="btn btn-outline-secondary ml-auto">Cancel</a>
            ...
            $('#id-pasien').on('change', (event) => {
              getDataPasien(event.target.value).then(pasien => {
                $('#id_pasien').remove();
                var id_pasien = '<input type="hidden" name="id_pasien" id="id_pasien" value=' + pasien.id +
                  ' readonly>';
