...
<div class="container">
  <div class="row d-flex">
    ...
    <div class="col-md-8 mt-3">
      ...
      <a href="{{ route('kandidat.edit', $kandidat->id) }}" class="btn text-white" style="background-color: #a979a8;"
        onmouseover="this.style.backgroundColor='#6c5576';" onmouseout="this.style.backgroundColor='#a979a8';">Edit
        Profil</a>
    </div>
  </div>
</div>
