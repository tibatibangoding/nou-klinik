			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
						<div class="card-title">Edit klinik</div>
						<a href="{{ route('klinik.index') }}" class="btn btn-primary btn-sm ml-auto">Back</a>
					</div>
				</div>
				...
				<div class="card-body">
					<form action="{{ route('klinik.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							...
							<br>
							@if ($klinik->logo != null)
								<img src="{{ asset(asset('/storage/' .$klinik->logo)) }}" class="img-preview img-fluid mb-2 mt-2 col-sm-4">
							@else
