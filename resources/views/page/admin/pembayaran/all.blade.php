...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">pembayaran <b class="text-success" style="font-size: 25px">(Bagi Yang Telah Melakukan Pembayaran)</b></h1>
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row, meta) {
                                ...
                                return '<a href="'+url+'" class="btn btn-primary text-center">Detail pembayaran dan pemeriksaan</a>';
                            }
                        }
                    ]
                });
