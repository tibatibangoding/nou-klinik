      ...
      <div class="card full-height">
        <div class="card-header">
          <div class="card-head-row">
            <h1 class="card-title">Tambah Jenis Obat</h1>
            <!-- <a href="{{ route('obat.create') }}" class="btn btn-primary btn-sm ml-auto">Back</a> -->
          </div>
        </div>

        <div class="card-body">
          <form action="{{ route('storeJenisObat') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
              ...
              <a href="{{ route('obat.create') }}" class="btn btn-outline-secondary ml-auto">Cancel</a>
